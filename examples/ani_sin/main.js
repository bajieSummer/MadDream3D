...
function initScene(){
    ...
    var mesh = MeshUtil.createColorPlane();
    var material = MaterialUtil.createFromShader(simple_vs,simple_fs);
...
function test_animation(scene,enti){
    ...
    var m1 = TransformAni(scene,enti.transform,
        {
        ...
        var m2 = TransformAni(scene,enti.transform,
            {
