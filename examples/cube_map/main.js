...
function createLights(scene){
    ...
    dlt.specular = new Mad3D.Vector3(1.0,1.0,1.0);
    ...
    scene.ambientLight = new Mad3D.Vector3(0.5,0.5,0.5);

}

function createEntity(scene){
   // var mesh = MeshUtil.createPlane(2,2,0);
   var mesh = Mad3D.MeshUtil.createSphere(1,30,30);
    var shaderOps = new Mad3D.ShaderOption();
...
function initScene(){
   ...
   //  gl.cullFace(gl.FRONT);
    ...
    var m2 = Mad3D.TransformAni(scene,cam.transform,
        {
