      ...
      if(state.loaded&& envCam.renderTarget.type ===Mad3D.TextureType.cube){
         ...
         if(envCam.drawMips){
            ...
            if(state.startShot){
               ...
               window.specMat.setUniform("roughness",Mad3D.UTypeEnumn.float,mipRough);
  ...
  // var folder = "../pics/steelplate1/"; //5
   ...
   // };
      ...
      document.getElementById("myRange").addEventListener("input",function(evt){
         ...
         chooseEnti.material.setUniform("metalness",Mad3D.UTypeEnumn.float,this.value*0.01);
   
      });
      document.getElementById("myRange2").addEventListener("input",function(evt){
         //console.log(this.value);
         chooseEnti.material.setUniform("roughness",Mad3D.UTypeEnumn.float,this.value*0.02);
   
      });
      document.getElementById("sp1_exposure").addEventListener("input",function(evt){
         //console.log(this.value);
         chooseEnti.material.setUniform("hdrExposure",Mad3D.UTypeEnumn.float,this.value*0.04);
